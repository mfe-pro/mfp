...
describe.skip(computedStyle.name, () => {
  ...
  it('should return element style', async () => {
    ...
    expect(await computedStyle(page, 'mfp-component')).toStrictEqual({ width: '20px' });
  });
  ...
  it('should return shadow element style', async () => {
    ...
    expect(await computedStyle(page, 'mfp-component >>> div')).toStrictEqual({ width: '30px' });
  });
  ...
  it('should filter element style', async () => {
    ...
    expect(await computedStyle(page, 'mfp-component', ['width'])).toStrictEqual({ width: '20px' });
  });
  ...
  it('should filter empty object if filter is []', async () => {
    ...
    expect(await computedStyle(page, 'mfp-component', [])).toStrictEqual({});
  });
  ...
  it('should throw error if element is not found', async () => {
    ...
    const page = await StencilCoreTesting.newE2EPage();
    expect(() => computedStyle(page, 'mfp-component')).toThrow('Could not find element mfp-component');
  });
  ...
  it('should throw error if element is not found in shadow dom', async () => {
    ...
    const page = await StencilCoreTesting.newE2EPage();
    expect(() => computedStyle(page, 'mfp-component >>> span')).toThrow('Could not find element  span');
  });
});
