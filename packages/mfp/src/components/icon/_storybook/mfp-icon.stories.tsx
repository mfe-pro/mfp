...
import mdx from './mfp-icon.mdx';
import { ICON_WEIGHT } from '../mfp-icon.types';
...
export const ExploreIcons: Story = {
  render: (args) => {
    ...
    return html`
      ...
      <mfp-button class="m-be-xxl" appearance="primary" href="https://phosphoricons.com/" target="_blank">
        <mfp-icon name="binoculars-fill" slot="prefix"></mfp-icon>
        Explore all the icons available
        <mfp-icon class="ms-m" name="caret-right" slot="suffix"></mfp-icon>
      </mfp-button>
      <!-- Warning block -->
      <mfp-alert class="m-be-l" type="warning" disable-close open>
        <mfp-icon name="warning-fill" slot="icon"></mfp-icon>
        Please notice
        <span slot="body">
