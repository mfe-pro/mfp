...
@Component({
  tag: 'mfp-progress',
  styleUrl: './scss/mfp-progress.scss',
  shadow: true,
})
export class MfpProgress {
  // Own Properties
  // ====================
  ...
  @Element() el!: HTMLMfpProgressElement;
  ...
  render() {
    const style = {
      ...(this.thickness === 'large' && { '--mfp-progress-bar--height': 'var(--mfp-spacing-xs)' }),
      ...(this.type === 'error' && { '--mfp-progress-bar--indicatorColor': 'var(--mfp-ui--danger)' }),
    };
        ...
        <div class="flex items-center" part="wrapper">
          <div class="relative flex items-center is-full" part="progress">
            ...
            {this.indeterminate && (
              <div
                class={{
                  'progress-bar__indeterminate absolute bg-[--mfp-progress-bar--indicatorColor] bs-[--mfp-progress-bar--height] is-[--mfp-progress-bar--indeterminateWidth]':
                    true,
