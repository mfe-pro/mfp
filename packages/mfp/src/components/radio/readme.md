...
| ------------ | -------------------------------------------------- | ---------------------------------- |
| `mfpBlur`    | Handler to be called when the radio loses focus    | `CustomEvent<HTMLMfpRadioElement>` |
| `mfpClick`   | Handler to be called when the radio state changes  | `CustomEvent<HTMLMfpRadioElement>` |
| `mfpFocus`   | Handler to be called when the radio gets focus     | `CustomEvent<HTMLMfpRadioElement>` |
| `mfpKeyDown` | Handler to be called when the radio key is pressed | `CustomEvent<KeyboardEvent>`       |
