...
| ----------- | ---------------------------------------------------- | ------------------------------------- |
| `mfpBlur`   | Handler to be called when the checkbox loses focus   | `CustomEvent<HTMLMfpCheckboxElement>` |
| `mfpChange` | Handler to be called when the checkbox state changes | `CustomEvent<{ checked: boolean; }>`  |
| `mfpFocus`  | Handler to be called when the checkbox gets focus    | `CustomEvent<HTMLMfpCheckboxElement>` |
