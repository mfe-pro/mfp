...
@Component({
  tag: 'mfp-checkbox',
  styleUrl: './scss/mfp-checkbox.scss',
  formAssociated: true,
  shadow: {
    delegatesFocus: true,
  },
})
export class MfpCheckbox {
  // Own Properties
  // ====================
  ...
  @Element() el!: HTMLMfpCheckboxElement;
  ...
  @Event() mfpFocus: EventEmitter<HTMLMfpCheckboxElement>;

  /** Handler to be called when the checkbox loses focus */
  @Event() mfpBlur: EventEmitter<HTMLMfpCheckboxElement>;
  ...
  render() {
    return (
      ...
      >
        <div
          class="mfp-checkbox__control relative box-border flex items-center justify-center bs-[--mfp-checkbox--size] is-[--mfp-checkbox--size] p-b-xs3 p-i-xs3"
          part="control"
        >
          <input
            type="checkbox"
            class="mfp-checkbox__input pointer-events-none absolute opacity-0 p-b-0 p-i-0 m-b-0 m-i-0"
          ...
          />
          <span
            class="mfp-checkbox__checkbox relative box-border flex items-center justify-center bs-full is-[--mfp-checkbox--size]"
            part="checkbox"
          >
            {/*
        ...
        <span
          class="mfp-checkbox__label ps-xs text-start font-medium leading-regular text-text-primary group-hover-[&:not(.is-disabled)]:text-hover-text-primary group-[.is-disabled]:opacity-60"
          part="label"
        >
          <slot />
        </span>
