...
| -------------- | ------------------------------------------------------------- | ------------------ |
| `mfpAfterHide` | Callback handler to be called after the alert has been hidden | `CustomEvent<any>` |
| `mfpAfterShow` | Callback handler to be called after the alert has been shown  | `CustomEvent<any>` |
| `mfpHide`      | Callback handler to be called when the alert is hidden        | `CustomEvent<any>` |
| `mfpShow`      | Callback handler to be called when the alert is shown         | `CustomEvent<any>` |
...
| `"btn-close"`    | The `mfp-button` used to close the alert                                                                                   |
...
| `"icon"`         | The `<mfp-icon>` element used to render a predefined icon based on the alert type (info, success, warning, error, default) |
...
graph TD;
  ...
  mfp-alert --> mfp-icon
  mfp-button --> mfp-icon
  style mfp-alert fill:#f9f,stroke:#333,stroke-width:4px
```
