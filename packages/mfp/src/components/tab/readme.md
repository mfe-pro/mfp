...
| ------------ | ------------------------------------------------ | -------------------------------- |
| `mfpBlur`    | Handler to be called when the tab loses focus    | `CustomEvent<HTMLMfpTabElement>` |
| `mfpClick`   | Handler to be called when the tab state changes  | `CustomEvent<HTMLMfpTabElement>` |
| `mfpFocus`   | Handler to be called when the tab gets focus     | `CustomEvent<HTMLMfpTabElement>` |
| `mfpKeyDown` | Handler to be called when the tab key is pressed | `CustomEvent<KeyboardEvent>`     |
