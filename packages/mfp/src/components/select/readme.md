...
| `debounceTime`      | `debounce-time`       | The amount of time, in milliseconds, to wait before emitting the `mfpInput` event after the input value changes. A value of 0 means no debouncing will occur. | `number`                                                                                                                                                             | `0`             |
...
| ----------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `mfpBlur`   | Callback handler emitted when the Select input loses focus        | `CustomEvent<HTMLMfpSelectElement>`                                                 |
| `mfpClear`  | Callback handler emitted when the selected value has been cleared | `CustomEvent<HTMLMfpSelectElement>`                                                 |
| `mfpFocus`  | Callback handler emitted when the Select input has received focus | `CustomEvent<HTMLMfpSelectElement>`                                                 |
| `mfpSelect` | Callback handler emitted when the selected value has changed      | `CustomEvent<{ value: string \| number \| string[]; item: HTMLMfpOptionElement; }>` |
...
| `"tag"`            | The tag container of the MfpTag for multiple selection.                                                |
| `"tag__base"`      | The base wrapper of the MfpTag for multiple selection.                                                 |
| `"tag__btn-close"` | The close button of the MfpTag for multiple selection.                                                 |
| `"tag__prefix"`    | The prefix slot container of the MfpTag for multiple selection.                                        |
| `"tag__text"`      | The text slot container of the MfpTag for multiple selection.                                          |
| `"tags"`           | The tags container of the MfpTags for multiple selection.                                              |
...
- [mfp-button](../button)
- [mfp-icon](../icon)
- [mfp-option-list](../option-list)

### Graph
```mermaid
graph TD;
  mfp-select --> mfp-tag
  mfp-select --> mfp-dropdown
  ...
  style mfp-select fill:#f9f,stroke:#333,stroke-width:4px
```
