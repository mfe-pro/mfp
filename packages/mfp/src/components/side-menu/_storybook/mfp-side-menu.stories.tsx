...
import mdx from './mfp-side-menu.mdx';
import { SIDE_MENU_APPEARANCE, SIDE_MENU_SIZE } from '../mfp-side-menu.types';

const meta: Meta = {
  title: 'Components/Side menu',
  component: 'mfp-side-menu',
  parameters: {
    docs: {
      page: mdx,
    },
  ...
  argTypes: {
    ...
    // Events
    mfpCollapse: { action: 'mfpCollapse' },
...
const Template = (args: Args) => html`
  ...
  >
    <div class="flex items-center gap-s py-6 pl-s" slot="logo">
      ...
      ${!args.collapse ? html`<h1 class="whitespace-nowrap text-xl">MFP</h1>` : nothing}
    </div>
    ...
    <mfp-side-menu-item disabled>
      <mfp-icon name="gauge" slot="prefix"></mfp-icon>
      Perfomance
    </mfp-side-menu-item>
    <mfp-side-menu-item>
      <mfp-icon name="truck" slot="prefix"></mfp-icon>
      Deliver
    </mfp-side-menu-item>
    <mfp-side-menu-item>
      <mfp-icon name="files" slot="prefix"></mfp-icon>
      Documents
    </mfp-side-menu-item>
    <mfp-side-menu-item>
      <mfp-icon name="stack" slot="prefix"></mfp-icon>
      Inventory
    </mfp-side-menu-item>
    <mfp-side-menu-item>
      <mfp-icon name="calendar" slot="prefix"></mfp-icon>
      Calendar
    </mfp-side-menu-item>
    <mfp-side-menu-item>
  ...
  <main class="grid grid-cols-1 p-m">
    ...
    <div class="border h-80 w-full border-dashed border-stroke-primary bg-[--mfp-ui--alt]">
      <!-- Your content -->
    </div>
  </main>
`;
  ...
  args: {
    footerContent: html`
      <div class="" slot="footer">
        <mfp-button appearance="text" slot="footer">
          <mfp-icon name="bell"></mfp-icon>
        </mfp-button>
        <mfp-button appearance="text" slot="footer">
          <mfp-icon name="chats-circle"></mfp-icon>
        </mfp-button>
        <mfp-button appearance="text" slot="footer">
          <mfp-icon name="sliders"></mfp-icon>
        </mfp-button>
      </div>
    `,
  },
