...
| --------------- | -------------------------------------------------------------------- | ------------------ |
| `mfpAfterClose` | Callback handler to be called after the notification has been closed | `CustomEvent<any>` |
| `mfpAfterOpen`  | Callback handler to be called after the notification has been opened | `CustomEvent<any>` |
| `mfpHide`       | Callback handler to be called when the notification is hidden        | `CustomEvent<any>` |
| `mfpShow`       | Callback handler to be called when the notification is shown         | `CustomEvent<any>` |
...
| Part             | Description                                                                                |
| ---------------- | ------------------------------------------------------------------------------------------ |
| `"base"`         | The `<div>` container of the predefined mfp-icon component.                                |
| `"body"`         | The container `<div>` that wraps the notification description content                      |
| `"btn-close"`    | The `mfp-button` used to close the notification                                            |
...
| `"icon"`         | The `<mfp-icon>` element used to render a predefined icon based on the notification type   |
...
| `"svg"`          | The `<svg>` element of the predefined mfp-icon component.                                  |
...
graph TD;
  ...
  mfp-button --> mfp-icon
  style mfp-notification fill:#f9f,stroke:#333,stroke-width:4px
```
