...
import mdx from './mfp-tag.mdx';
import { TAG_BORDER_RADIUS, TAG_COLOR, TAG_SIZE, TAG_VARIANT } from '../mfp-tag.types';
...
const Template = (args: Args) => html`
  ...
  >
    ${args.icon ? html`<mfp-icon name=${args.icon} slot="prefix"></mfp-icon>` : nothing} ${args.text}
  </mfp-tag>
`;
