...
import { BADGE_SIZE, TBadgeSize } from './mfp-badge.types';
...
@Component({
  tag: 'mfp-badge',
  styleUrl: './scss/mfp-badge.scss',
  shadow: true,
})
export class MfpBadge {
  // Own Properties
  // ====================
  ...
  @Element() el: HTMLMfpBadgeElement;
  ...
  render() {
    const styles = {
      ...(this.backgroundColor && { '--mfp-badge--background-color': getColorCSSVariable(this.backgroundColor) }),
      ...(this.textColor && { '--mfp-badge--text-color': getColorCSSVariable(this.textColor) }),
    };
