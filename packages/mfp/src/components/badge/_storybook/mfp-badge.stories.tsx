...
import mdx from './mfp-badge.mdx';
import { BADGE_SIZE } from '../mfp-badge.types';
...
const Template = (args: Args) => html`
  <mfp-badge background-color=${args['background-color']} size=${args.size} text-color=${args['text-color']}>
    ${args.content}
  </mfp-badge>
`;
