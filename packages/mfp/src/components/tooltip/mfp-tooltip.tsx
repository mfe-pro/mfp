...
@Component({
  tag: 'mfp-tooltip',
  styleUrl: './scss/mfp-tooltip.scss',
  shadow: true,
})
export class MfpTooltip {
  // Own Properties
  // ====================
  ...
  // ===================================
  @Element() el!: HTMLMfpTooltipElement;
  ...
  render() {
    return (
      <div class="mfp-tooltip relative" part="base">
        {/* TRIGGER */}
        <div
          class="mfp-tooltip--trigger"
        ...
        <div
          ...
          part="panel"
        >
          {!this.hideArrow && <div class="mfp-tooltip--arrow" ref={(el) => (this.arrow = el)} />}
          <slot />
        </div>
      </div>
    );
