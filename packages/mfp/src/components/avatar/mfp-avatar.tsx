...
import { AVATAR_SHAPE, AVATAR_SIZE, TAvatarShape, TAvatarSize } from './mfp-avatar.types';
...
@Component({
  tag: 'mfp-avatar',
  styleUrl: './scss/mfp-avatar.scss',
  shadow: true,
})
export class MfpAvatar {
  // Own Properties
  // ====================
  ...
  @Element() el!: HTMLMfpAvatarElement;
      ...
      <Host>
        <div
          class={{
            'mfp-avatar': true,
            [`size--${this.size}`]: true,
            'rounded-[--mfp-avatar--border-radius-circle]': this.shape === 'circle',
            'rounded-[--mfp-avatar--border-radius-squareXs]': this.shape === 'square' && this.size === 'xsmall',
            'rounded-[--mfp-avatar--border-radius-squareS]': this.shape === 'square' && this.size === 'small',
            'rounded-[--mfp-avatar--border-radius-squareM]':
        ...
        <div
          class={{
            ...
            'start-[--mfp-avatar--badge-left-square] inset-bs-[--mfp-avatar--badge-top-square]':
              this.shape === 'square',
            'start-[--mfp-avatar--badge-left-circle] inset-bs-[--mfp-avatar--badge-top-circle]':
              this.shape === 'circle',
          }}
        >
