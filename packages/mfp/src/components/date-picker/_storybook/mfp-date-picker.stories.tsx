...
import mdx from './mfp-date-picker.mdx';
import { INPUT_VALIDATION } from '../../input/mfp-input.types';
import { DATE_PICKER_TYPE } from '../mfp-date-picker.types';
  ...
  render: (args) => html`
    <div class="grid grid-cols-1 gap-m sm:grid-cols-3">
      ...
      <div class="flex flex-col gap-2">
        ...
        ${Template({ ...args, value: '2024-05-25', name: 'mfp-date-picker-default', noLabel: 'true' })}
      </div>
      <!-- Range date picker -->
      <div class="flex flex-col gap-2">
