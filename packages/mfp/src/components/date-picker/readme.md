...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| `mfpBlur`   | Callback handler emitted when the input loses focus                                                                                                                                                                            | `CustomEvent<HTMLMfpDatePickerElement>`                         |
| `mfpChange` | Callback handler emitted when the input value has changed and the input loses focus. This handler is called whenever the user finishes typing or pasting text into the input field and then clicks outside of the input field. | `CustomEvent<{ value: string; el: HTMLMfpDatePickerElement; }>` |
| `mfpClear`  | Callback handler emitted when the input value has been cleared                                                                                                                                                                 | `CustomEvent<HTMLMfpDatePickerElement>`                         |
| `mfpFocus`  | Callback handler emitted when the input has received focus                                                                                                                                                                     | `CustomEvent<HTMLMfpDatePickerElement>`                         |
...
```mermaid
graph TD;
  mfp-date-picker --> mfp-dropdown
  mfp-date-picker --> mfp-button
  mfp-date-picker --> mfp-icon
  mfp-dropdown --> mfp-panel
  mfp-button --> mfp-icon
  style mfp-date-picker fill:#f9f,stroke:#333,stroke-width:4px
```
