 ...
 */
@Component({
  tag: 'mfp-breadcrumb-item',
  styleUrl: './scss/mfp-breadcrumb-item.scss',
  shadow: true,
})
export class MfpBreadcrumbItem {
  // Own Properties
  // ====================
  ...
  @Element() el!: HTMLMfpBreadcrumbItemElement;
  ...
  @Event() mfpBlur: EventEmitter<HTMLMfpBreadcrumbItemElement>;

  /** Handler to be called when item is focused */
  @Event() mfpFocus: EventEmitter<HTMLMfpBreadcrumbItemElement>;

  /** Handler to be called when item is clicked */
  @Event() mfpClick: EventEmitter<HTMLMfpBreadcrumbItemElement>;
