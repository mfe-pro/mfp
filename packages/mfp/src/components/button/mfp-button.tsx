...
@Component({
  tag: 'mfp-button',
  styleUrl: './scss/mfp-button.scss',
  shadow: true,
})
export class MfpButton {
  // Own Properties
  // ====================
  ...
  @Element() el!: HTMLMfpButtonElement;
  ...
  @Event() mfpBlur: EventEmitter<HTMLMfpButtonElement>;

  /** Handler to be called when the button is clicked */
  @Event() mfpFocus: EventEmitter<HTMLMfpButtonElement>;

  /** Handler to be called when button gets focus */
  @Event() mfpClick: EventEmitter<HTMLMfpButtonElement>;
  ...
  render() {
    ...
    const style = {
      ...(this.border && { '--mfp-button--border-radius': `var(--mfp-radius--${this.border})` }),
    };
    ...
    return (
      <Host style={style}>
        <TagElem
          class={{
            'mfp-button': true,
            [`mfp-button--${this.appearance}`]: true,
        ...
        >
          <span class="mfp-button__prefix" ref={(spanElem) => (this.prefixElem = spanElem)} part="prefix">
            <slot name="prefix" onSlotchange={this.handleSlotChange} />
          </span>
          <span class="mfp-button__label" part="label">
            <slot />
          </span>
          <span class="mfp-button__suffix" ref={(spanElem) => (this.suffixElem = spanElem)} part="suffix">
            <slot name="suffix" onSlotchange={this.handleSlotChange} />
          </span>
          {this.loading && (
            <mfp-icon
              class="mfp-button__loader"
              name="spinner-gap"
              role="img"
