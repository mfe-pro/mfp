...
| `debounceTime`             | `debounce-time`     | The amount of time, in milliseconds, to wait before emitting the `mfpInput` event after the textarea value changes. A value of 0 means no debouncing will occur.                                                                                   | `number`                                                  | `0`         |
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| `mfpBlur`   | Callback handler emitted when the textarea loses focus                                                                                                                                                                                     | `CustomEvent<HTMLMfpTextareaElement>`                         |
| `mfpChange` | Callback handler emitted when the textarea value has changed and the textarea loses focus. This handler is called whenever the user finishes typing or pasting text into the textarea field and then clicks outside of the textarea field. | `CustomEvent<{ value: string; el: HTMLMfpTextareaElement; }>` |
| `mfpClear`  | Callback handler emitted when the textarea value has been cleared                                                                                                                                                                          | `CustomEvent<HTMLMfpTextareaElement>`                         |
| `mfpFocus`  | Callback handler emitted when the textarea has received focus                                                                                                                                                                              | `CustomEvent<HTMLMfpTextareaElement>`                         |
| `mfpInput`  | Callback handler emitted when the textarea value changes. This handler is called whenever the user types or pastes text into the textarea field.                                                                                           | `CustomEvent<{ value: string; el: HTMLMfpTextareaElement; }>` |
