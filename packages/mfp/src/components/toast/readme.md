...
| --------- | ------------------------------------------------------------- | ---------------------------------- |
| `mfpHide` | Callback handler to be called when the notification is hidden | `CustomEvent<HTMLMfpToastElement>` |
| `mfpShow` | Callback handler to be called when the notification is shown  | `CustomEvent<HTMLMfpToastElement>` |
...
| Part          | Description                                               |
| ------------- | --------------------------------------------------------- |
| `"base"`      | The `<div>` container of the internal mfp-icon component. |
| `"icon"`      |                                                           |
| `"icon-info"` | The `<div>` container that holds the icon component.      |
| `"svg"`       | The `<svg>` element of the internal mfp-icon component.   |
...
graph TD;
  mfp-toast --> mfp-icon
  style mfp-toast fill:#f9f,stroke:#333,stroke-width:4px
```
