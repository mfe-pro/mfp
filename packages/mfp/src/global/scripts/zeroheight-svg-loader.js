 ...
 * This file will allow loading SVG assets from `@mfp/core/dist/mfp/svg` folder inside the code preview.
 */

const proxyFetch = {
  apply(target, _thisArg, args) {
    if (args[0].startsWith('/svg/')) {
      return import(`./node_modules/@mfp/core/dist/mfp${args[0]}`).then(
